...
export class SeekerChatbotPage {
  ...
  sendText(){
      /*
    let param = {"job_id" : this.job_id, "sender_type" : sender_type, "seeker_id" : this.config.user_id, "message_text" : this.text, "question_weight" : question_weight, "answer_weight" : answer_weight, "answer_correct" : answer_correct};*/
  }
